...
# curl -k -m 10 https://10.173.202.26/service/autoreport/hold/EvtApplication_Today.txt >"/home/matt-teixeira/hep3/hhm_data_acquisition/test_logs/Application.log"
