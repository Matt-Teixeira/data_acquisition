...
timeout 240 lftp -c "set sftp:connect-program 'ssh -o KexAlgorithms=diffie-hellman-group1-sha1 -oConnectTimeout=10 -oServerAliveInterval=10 -oServerAliveCountMax=6';
set net:timeout 10;
